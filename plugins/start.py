...
botid = token.split(':')[0]
FLOOD = 1
LAZY_PIC = os.environ.get("LAZY_PIC", "https://i.ibb.co/dk514bb/file-268.jpg")
	...
	I am file renamer bot, Please sent any telegram**Document Or Video** and enter new filename to rename it"""
        await message.reply_photo(photo=LAZY_PIC,
                                ...
                                reply_markup=InlineKeyboardMarkup(
                                      [[InlineKeyboardButton("🔺 Update Channel 🔺", url="https://t.me/Anumitultrabots")],
                                      [InlineKeyboardButton("🦋 Subscribe us 🦋", url="https://youtube.com/@Anumitultrabots")],
                                      [InlineKeyboardButton("Support Group", url='https://t.me/music_247_on'),
                                      InlineKeyboardButton("Movie Channel", url='https://t.me/movierequestgrouppro')],
                                      [InlineKeyboardButton("☕ Buy Me A Coffee ☕", url='https://p.paytm.me/xCTH/91w67bf3')]
                                      ]))
        return
    if id:
        if old == True:
...
async def send_doc(client, message):
    ...
    try:
        ...
        await message.reply_text(text=f"Hello dear {message.from_user.first_name}  **we are currently working on this issue**\n\nPlease try to rename files from your another account.\nBecause this BOT can't rename file sent by some ids.\n\nIf you are an **ADMIN** Don't worry ! here we have a solution for you dear {message.from_user.first_name }.\n\nPlease use \n👉 `/addpremium your_other_userid` 👈 to use premium feautres\n\n",
                                  reply_markup=InlineKeyboardMarkup([
                                                                     [InlineKeyboardButton("🦋 Contact LazyDeveloper 🦋", url='https://telegram.me/Anumitultrabots')],
                                                                     [InlineKeyboardButton("🔺 Watch Tutorial 🔺", url='https://youtube.com/@Anumitultrabots')],
                                                                     [InlineKeyboardButton("🦋 Visit Channel  ", url='https://t.me/Anumitultrabots'),
